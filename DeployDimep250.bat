...
REM ---------------------------------------------------------------------------
REM ENCERRAR TODAS AS INSTâNCIAS ATIVAS
REM ---------------------------------------------------------------------------
...
REM ---------------------------------------------------------------------------
REM SE NÃO EXISTIR O C:\TEMP IRÁ CRIAR 
REM ---------------------------------------------------------------------------
...
REM ---------------------------------------------------------------------------
REM SE NÃO EXISTIR O C:\TEMP\DIMEP FINAL IRÁ CRIAR 
REM ---------------------------------------------------------------------------
REM Criar diretório temp se não existir
if not exist "C:\temp\DIMEP FINAL" mkdir "C:\temp\DIMEP FINAL" >nul 2>&1


REM ---------------------------------------------------------------------------
REM SE NÃO EXISTIR OS ARQUIVOS DE INSTALAÇÕES E SCRIPT 
REM ---------------------------------------------------------------------------

REM Criar diretório se não existir
if not exist "C:\temp\DIMEP FINAL\" mkdir "C:\temp\DIMEP FINAL"

REM Realizar o download dos arquivos se não existir
if not exist "C:\temp\DIMEP FINAL\ExecuteSilent.vbs" (
    powershell -ExecutionPolicy Bypass -Command "$progressPreference = 'silentlyContinue'; iwr 'https://raw.githubusercontent.com/eduardogrigorio/Kairos-Dimep-Desktop-2.5.0/main/ExecuteSilent.vbs' -OutFile 'C:\temp\DIMEP FINAL\ExecuteSilent.vbs'"
) >nul 2>&1

if not exist "C:\temp\DIMEP FINAL\IntaladorDimep2.5.0.msi" (
    powershell -ExecutionPolicy Bypass -Command "$progressPreference = 'silentlyContinue'; iwr 'https://github.com/eduardogrigorio/Kairos-Dimep-Desktop-2.5.0/raw/main/IntaladorDimep2.5.0.msi' -OutFile 'C:\temp\DIMEP FINAL\IntaladorDimep2.5.0.msi'"
) >nul 2>&1

if not exist "C:\temp\DIMEP FINAL\Kairos Desktop.exe" (
    powershell -ExecutionPolicy Bypass -Command "$progressPreference = 'silentlyContinue'; iwr 'https://github.com/eduardogrigorio/Kairos-Dimep-Desktop-2.5.0/raw/main/Kairos%%20Desktop.exe' -OutFile \"C:\temp\DIMEP FINAL\Kairos Desktop.exe\""
) >nul 2>&1

if not exist "C:\temp\DIMEP FINAL\DeployDimep250.bat" (
    powershell -ExecutionPolicy Bypass -Command "$progressPreference = 'silentlyContinue'; iwr 'https://github.com/eduardogrigorio/Kairos-Dimep-Desktop-2.5.0/blob/main/DeployDimep250.bat' -OutFile 'C:\temp\DIMEP FINAL\DeployDimep250.bat'"
) >nul 2>&1



REM ---------------------------------------------------------------------------
REM Verificando se versao 2.5.0 ja esta instalada
REM ---------------------------------------------------------------------------
